...
<body>
    ...
    <div class="container-fluid pt-5">
        ...
        <div class="row px-xl-5 pb-3">
            ...
            <?php
            $sql = "SELECT DISTINCT Category,(SELECT count(id) FROM product WHERE Category=p.Category) AS count,c.image_url FROM product p LEFT JOIN category c ON p.Category=c.category_name GROUP BY c.category_name ORDER BY p.created_date DESC LIMIT 8";
                        ...
                        <a class="text-decoration-none" href="">
                            <div class="cat-item d-flex align-items-center mb-4">
                                <div class="overflow-hidden" style="width: 100px; height: 100px;">
                                    <img class="img-fluid" src="<?= $this_site_url . $row['image_url'] ?? ''; ?>" alt="image">
                                </div>
    ...
    <div class="container-fluid pt-5 pb-3">
        ...
        <div class="row px-xl-5">
            <?php
            $qry = "SELECT * FROM product WHERE label=1 ORDER BY created_date DESC LIMIT 12";
    ...
    <div class="container-fluid pt-5 pb-3">
        <h2 class="section-title position-relative text-uppercase mx-xl-5 mb-4"><span class="bg-secondary pr-3">Sponsored Products</span></h2>
        <div class="row px-xl-5">
            <?php
            $qry = "SELECT * FROM product WHERE label=2 ORDER BY created_date DESC LIMIT 12";
            $res = mysqli_query($conn, $qry);
            if (!$res) {
                errlog(mysqli_error($conn), $qry);
            }
    ...
    <div class="container-fluid pt-5 pb-3">
        ...
        <div class="row px-xl-5">
            ...
            if (isset($_COOKIE['recent_items'])) {
                $items = json_decode($_COOKIE['recent_items'], true);
                // print_r($items);
                for ($i = 0; $i <= count($items) - 1; $i++) {
                    for ($j = $i + 1; $j <= count($items) - 1; $j++) {

                        if ($items[$i]['visit_time'] < $items[$j]['visit_time']) {
                            $temp = $items[$i]['visit_time'];
                            $items[$i]['visit_time'] = $items[$j]['visit_time'];
                            $items[$j]['visit_time'] = $temp;
                            $temp = $items[$i]['id'];
            ...
            ?>
                    ...
                    <div class="col-lg-2 col-md-4 col-sm-6 pb-1">
                        <div class="product-item bg-light mb-4">
                            <div class="product-img position-relative overflow-hidden">
                                <img class="img-fluid w-100" src="<?= $this_site_url . $row['pic'] ?? ''; ?>" alt="">
                                <div class="product-action">
                                    <a class="btn btn-outline-dark btn-square" onclick="addCart(this)" value="<?= $row['id']; ?>" href="javascript:void(0)"><i class="fa fa-shopping-cart"></i></a>
                                    <a class="btn btn-outline-dark btn-square" onclick="addWishlist(this)" value="<?= $row['id']; ?>" href="javascript:void(0)"><i class="far fa-heart"></i></a>
                                    <a class="btn btn-outline-dark btn-square" href="javascript:void(0)"><i class="fa fa-sync-alt"></i></a>
