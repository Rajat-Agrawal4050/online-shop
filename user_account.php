...
<body>
	...
	?>
		...
		$result_object = mysqli_query($conn, $sql);
		...
		<div class="features_items text-center">
			...
			<div style="display: flex; flex-direction: column;">
				...
				<div style="height: 200px;width: 150px; position: absolute;top: 46%;left: 70%;">
					<img src="<?php echo '.' . $pic; ?>" style="max-width: 150px; max-height: 200px;">
				</div>
